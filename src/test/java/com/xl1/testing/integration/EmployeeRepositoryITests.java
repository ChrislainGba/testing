...
public class EmployeeRepositoryITests {
	...
	//JUnit Integration test for save employee operation
	@DisplayName("JUnit Integration  Repository test for save employee operation")
	@Test
	...
	@DisplayName("JUnit Integration  Repository test for findAll employees operation")
	@Test
	...
	//JUnit Integration Repository test for getEmployeeById
	@DisplayName("Junt Integration  Repository test for getEmployeeById")
	@Test
	...
	//JUnit Integration  Repository test for getEmployeeByEmail
	@DisplayName("JUnit Integration Repository test for getEmployeeByEmail")
	@Test
	...
	//JUnit Integration Repository test for update employee operation
	@DisplayName("JUnit Integration Repository test for update employee operation")
	@Test
	...
	//JUnit Integration Repository test for delete employee operation
	@DisplayName("JUnit Integration Repository test for delete employee operation")
	@Test
	...
	//JUnit Integration Repository test for custom query using JPQL with index
	@DisplayName("JUnit Integration Repository test for custom query using JPQL with index params")
	@Test
	...
	//JUnit Integration Repository test for custom query using JPQL with named params
		@DisplayName("JUnit Integration Repository test for custom query using JPQL with named params")
		@Test
		...
		//JUnit Integration Repository test for custom query using native SQL with index params
		@DisplayName("JUnit Integration Repository test for custom query using native SQL with index params")
		@Test
		...
		//JUnit Integration Repository test for custom query using native SQL with named params
		@DisplayName("JUnit Integration Repository test for custom query using native SQL with named params")
		@Test
